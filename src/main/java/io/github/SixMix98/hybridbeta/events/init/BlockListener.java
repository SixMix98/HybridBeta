...
public class BlockListener {
    ...
    public void registerBlocks(BlockRegistryEvent event) {
        ...
        BRICK_STAIRS = new TemplateStairsBlock(InitListener.NAMESPACE.id("brick_stairs"), Block.BRICKS).ignoreMetaUpdates().setTranslationKey(InitListener.NAMESPACE, "brick_stairs");
        BRICK_STAIRS = new TemplateStairsBlock(InitListener.NAMESPACE.id("sandstone_stairs"), Block.SANDSTONE).ignoreMetaUpdates().setTranslationKey(InitListener.NAMESPACE, "sandstone_stairs");
        blocks = new Block[] {
                REDSTONE_BLOCK,
                COAL_BLOCK,
                BRICK_STAIRS,
